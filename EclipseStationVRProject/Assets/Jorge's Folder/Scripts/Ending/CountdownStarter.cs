...
{
    public TextMeshProUGUI countdownText;
    public TextMeshProUGUI countdownText02;
    public TextMeshProUGUI countdownText03;
    public GameObject goodEndingCanvas;
    public GameObject gameOverCanvas;
    public AudioSource systemRebootAudio;
    public AudioSource explosionAudio;
    ...
    private void Start()
    {
        ...
        if (CheckpointData.hasCheckpoint)
        {
            ...
            if (player != null)
            {
                ...
                player.transform.rotation = CheckpointData.checkpointRotation;
            }
        }
    }
    ...
    private IEnumerator GoodEndingSequence()
    {
        ...
        // Load Good Ending Scene (replace with your scene name or index)
    ...
    private IEnumerator BadEndingSequence()
    {
        ...
        // Load Bad Ending Scene (replace with your scene name or index)
    ...
    private void UpdateCountdownDisplay()
    {
        ...
        int seconds = Mathf.FloorToInt(countdownTime % 60);
        countdownText.text = string.Format("{0:00}:{1:00}", minutes, seconds);
        countdownText02.text = string.Format("{0:00}:{1:00}", minutes, seconds);
        countdownText03.text = string.Format("{0:00}:{1:00}", minutes, seconds);
    }
    ...
    private void MovePlayerToStart()
    {
        ...
        //Added for Retry
        CheckpointData.checkpointPosition = checkpointLocation.position;
        CheckpointData.checkpointRotation = checkpointLocation.rotation;
